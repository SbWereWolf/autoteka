...
Фишки: 
- самая быстрая доставка (по умолчанию), 
- акции, 
- круглосуточно.
...
- Для ~5/7 магазинов используются сгенерированные изображения.
...
- Все кликабельные элементы имеют реакцию: светлые темы — темнее,
  тёмные — светлее.
- Кнопки используют тот же bounce, что и плитки.
...
- Интерактивные состояния не привязывать к ширине (break point), а
...
- Режим работы — оверлей на полупрозрачной плашке (не мене 0.8).
