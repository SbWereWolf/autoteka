...
10. на host приводит runtime-каталоги Laravel к состоянию,
...
18. проверяет запись Laravel в SQLite/session/cache;
19. снимает maintenance mode;
20. поднимает или перезапускает контейнер `web`;
21. выполняет HTTP smoke-check `GET /admin/login`;
22. отправляет success-уведомление в Telegram с hash и `subject`
