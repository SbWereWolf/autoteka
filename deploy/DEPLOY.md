...
**`deploy/config/journald-limits.conf` →
...
**`deploy/systemd/docker.override.conf` →
...
`deploy/systemd/` и устанавливаются `install.sh`:
...
**`deploy/systemd/watch-changes.service`**
...
**`deploy/systemd/watch-changes.timer`**
